  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-sm mt-0.5" style={{ color: "#7A9878" }}>{certs?.length ?? 0} certificate{certs?.length !== 1 ? "s" : ""} earned</p>
      </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs mt-0.5" style={{ color: "#9AB89E" }}>
                    #{cert.certificate_number} · Issued{" "}
