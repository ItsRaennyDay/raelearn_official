...
export default async function ReportsPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        <h1 className="font-extrabold text-2xl" style={{ fontFamily: "var(--font-head)", color: "#1A2E1C" }}>Reports</h1>
        <p className="text-sm mt-0.5" style={{ color: "#7A9878" }}>Platform-wide analytics snapshot</p>
      </div>

      <div className="grid grid-cols-3 gap-4 mb-8">
        {metrics.map((m) => (
          <div key={m.label} className="rounded-2xl p-5" style={{ background: "#fff", border: "1.5px solid #E8EDE6" }}>
            <div
            ...
            <div className="text-sm font-semibold" style={{ color: "#4A6650" }}>{m.label}</div>
          </div>
        ))}
      </div>

      <div className="rounded-2xl p-10 text-center" style={{ background: "#fff", border: "1.5px solid #E8EDE6" }}>
        ...
        <h2 className="font-bold text-lg mb-2" style={{ fontFamily: "var(--font-head)", color: "#1A2E1C" }}>Advanced Analytics</h2>
