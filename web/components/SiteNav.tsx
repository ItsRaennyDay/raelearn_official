          ...
          <div className="hidden md:flex items-center gap-3 ml-auto">
            {user ? (
              ...
              <>
                ...
                <GroupAccountCTA className="text-sm font-bold text-[#2A5230] bg-transparent border-[1.5px] border-[#2A5230] px-[15px] py-[9.5px] rounded-[10px] whitespace-nowrap hover:bg-[#2A5230] hover:text-white transition-colors">
